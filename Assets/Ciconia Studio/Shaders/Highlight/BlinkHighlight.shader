Shader "Ciconia Studio/Effects/Highlight/BlinkHighlight" {
    Properties {
        ...
        [Space(15)]_HighlightColor ("Color", Color) = (0, 0.45,.129,1)
        _FresnelSpread ("Fresnel Spread", Range(0, 5)) = 2
        _FresnelStrength ("Fresnel Intensity", Range(0, 8)) = 4
...
/// Final Color:
                float3 finalColor = diffuse/20 + specular;
